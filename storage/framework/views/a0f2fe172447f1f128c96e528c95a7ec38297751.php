...
<body class="hold-transition theme-primary bg-gradient-primary">
  ...
  <input type="password" id="password" name="password" class="form-control pl-15 bg-transparent text-white plc-white" placeholder="Password">
    ...
    <div class="text-center">
        <p class="mt-15 mb-0 text-white">Don't have an account? <a href="<?php echo e(route('register')); ?>" class="text-info ml-5">Sign Up</a></p>
                            </div>
                        </div>
                    </div>
                </div>
...
<?php /**PATH C:\xampp5\htdocs\school\resources\views/auth/login.blade.php ENDPATH**/ ?>